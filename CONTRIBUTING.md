...
Before asking a question, please check existing [issues](https://github.com/szkiba/xk6-g0/issues) and search online for solutions. If you still need help, clarification, or want to connect with the team and community, join our [community forums](https://community.grafana.com/c/grafana-k6).

## Reporting Bugs

Report bugs and errors using GitHub [issues](https://github.com/szkiba/xk6-g0/issues).
...
Feature requests are managed as GitHub [issues](https://github.com/szkiba/xk6-g0/issues).

Before submitting a new suggestion:

* Ensure you are using the latest version.  
* Carefully review the documentation to see if the functionality already exists.  
* Search existing [issues](https://github.com/szkiba/xk6-g0/issues) to avoid duplicates and add a comment if your idea is already present.  
...
1. Check existing [issues](https://github.com/szkiba/xk6-g0/issues) or create a new one to discuss your intended fix or feature.  
...
```bash
xk6 build --with github.com/szkiba/xk6-g0=.
```
