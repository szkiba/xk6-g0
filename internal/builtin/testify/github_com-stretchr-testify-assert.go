...
func init() {
	Symbols["github.com/stretchr/testify/assert/assert"] = map[string]reflect.Value{
		...
		"EqualExportedValues":           reflect.ValueOf(assert.EqualExportedValues),
		"EqualExportedValuesf":          reflect.ValueOf(assert.EqualExportedValuesf),
		...
		"EventuallyWithT":               reflect.ValueOf(assert.EventuallyWithT),
		"EventuallyWithTf":              reflect.ValueOf(assert.EventuallyWithTf),
		...
		"IsNotType":                     reflect.ValueOf(assert.IsNotType),
		"IsNotTypef":                    reflect.ValueOf(assert.IsNotTypef),
		...
		"NotElementsMatch":              reflect.ValueOf(assert.NotElementsMatch),
		"NotElementsMatchf":             reflect.ValueOf(assert.NotElementsMatchf),
		...
		"NotErrorAs":                    reflect.ValueOf(assert.NotErrorAs),
		"NotErrorAsf":                   reflect.ValueOf(assert.NotErrorAsf),
		"NotErrorIs":                    reflect.ValueOf(assert.NotErrorIs),
		"NotErrorIsf":                   reflect.ValueOf(assert.NotErrorIsf),
		"NotImplements":                 reflect.ValueOf(assert.NotImplements),
		"NotImplementsf":                reflect.ValueOf(assert.NotImplementsf),
		...
		"ObjectsExportedFieldsAreEqual": reflect.ValueOf(assert.ObjectsExportedFieldsAreEqual),
		...
		"CollectT":                reflect.ValueOf((*assert.CollectT)(nil)),
		...
		"PanicAssertionFunc":      reflect.ValueOf((*assert.PanicAssertionFunc)(nil)),
